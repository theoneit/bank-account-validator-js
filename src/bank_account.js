...
const bankAccount = {
  ...
  validate(params){
    ...
    if(validator.isAgencyNumberValid(params.agencyNumber) && validator.isAgencyCheckNumberValid(params.agencyCheckNumber)){
    ...
    if(validator.isAccountNumberValid(params.accountNumber) && validator.isAccountCheckNumberValid(params.accountCheckNumber)){
